                ...
                {data.map((item, index) => (
                    <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            ...
                            <div className="flex-col hidden gap-2 text-xl font-bold md:pl-10 md:flex md:text-4xl text-neutral-300">
                                <h3>
                                    {item.date}
                                </h3>
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            <div className="block mb-4 text-2xl md:hidden font-bold text-left text-neutral-300">
                                <h3>{item.date}</h3>
                                <h3>{item.job}</h3>
                            </div>
