        ...
        <section className="c-space section-spacing">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
                ...
                <div className="flex items-end grid-default-color grid-1">
                    ...
                    <div className="z-10">
                        <p className="headtext">Hi, I'm Hasham Tanveer</p>
                        <p className="subtext">
                            Over past few months, I have developed Full
                            Stack Applications. And also hosted them online
                            on the servers.
                            I thrive to build scalable web Apps.
                        </p>
                    </div>
                ...
                <div className="grid-black-color grid-3">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">
                            I'm based in Pakistan, and open to work worldwide.
                        </p>
                    </div>
                ...
                <div className="grid-default-color grid-5">
                    <div className="z-10 w-[50%]">
                        ...
                        <p className="subtext">
                            I specialize in variety of languages, frameworks
                            and tools that allow me to build robust scalable applications
                        </p>
                    </div>
